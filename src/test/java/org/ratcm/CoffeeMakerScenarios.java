...
public class CoffeeMakerScenarios {
	...
	//Debut TP check inventory before use
	
	private void testChekInventoryBeforeUse() {
		String test = "Coffee: 15\n" 
				+ "Milk: 15\n" 
				+ "Sugar: 15\n" 
				+ "Chocolate: 15\n";
		assert (test.equals(cm.checkInventory()));

		System.out.println("testChekInventoryBeforeUse passed with succes");
	}
	
	// test Making Many Coffees After Refill Is Still Possible
	...
	private void testMakingManyCoffeesAfterRefillIsStillPossible() {
		...
		System.out.println("testMakingManyCoffeeAfterRefillIsStillPossible passed with succes");
	}
	
	//testChekInventoryAfterThreeCoffees()
	...
	private void testChekInventoryAfterThreeCoffees() {
		...
		assertEquals(0, cm.makeCoffee(0, 50));
		assertEquals(0, cm.makeCoffee(0, 50));
		String test = "Coffee: 6\n" 
				+ "Milk: 12\n" 
				+ "Sugar: 12\n" 
				+ "Chocolate: 15\n";
		assert (test.equals(cm.checkInventory()));
		System.out.println("testChekInventoryAfterThreeCoffees passed with succes");
...
//		testScenario.testChekInventoryBeforeUse();
